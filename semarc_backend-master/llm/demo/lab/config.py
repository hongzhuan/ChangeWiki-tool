...
# [step 1]>> 如果调用在线大模型则需要填写api-key，格式如 "sk-123456789xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx123456789"。极少数情况下，还需要填写组织（格式如org-123456789abcdefghijklmno的），请向下翻，找 API_ORG 设置项
API_KEY = "sk-asiQXyHCXxVUzf05Aa76EaFfFbA14bDcA4A75dB19d3264Fd" #openai
DEEPSEEK_API_KEY = "sk-bd9d22ac16664f129ea02bf6d508bcbf" #deepseek
...
# 多线程函数插件中，默认允许多少路线程同时请求大模型。在线大模型的并发数参考官方文档，本地大模型的并发数上限取决于服务器资源。
DEFAULT_WORKER_NUM = 32 #GPU服务器建议设置为16，本地大模型建议不大于3，在线API可以设置为32
...
LLM_MODEL = "ollama-deepseek-v2:16b" # 可选 ↓↓↓
AVAIL_LLM_MODELS = ["qwen-max", "o1-mini", "o1-mini-2024-09-12", "o1", "o1-2024-12-17", "o1-preview", "o1-preview-2024-09-12",
                    ...
                    "deepseek-chat", "deepseek-coder", "deepseek-reasoner","deepseek-ai/DeepSeek-R1",
                    "ollama-llama3.1:8b","ollama-deepseek-r1:7b","ollama-deepseek-coder:6.7b","ollama-deepseek-v2:16b","ollama-llama3:8b","ollama-gemma3:27b"
                    ]   #gpu服务器大模型建议选dsV2
