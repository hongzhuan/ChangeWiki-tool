...
# 加载JSON文件1和JSON文件2
with open('E:\\XJTU\\架构逆向\\lda_demoGPT\\res\\libuv_new-1.44\\libuv_new-1.44-res.json', 'r', encoding='utf-8') as f:
    json_data_1 = json.load(f)

with open('E:\\XJTU\\架构逆向\\lda_demoGPT\\res\\libuv_new-1.48\\libuv_new-1.48-res.json', 'r', encoding='utf-8') as f:
...
# 将修改后的结果保存为新的JSON文件3
with open('E:\\XJTU\\架构逆向\\lda_demoGPT\\res\\libuv_new-1.48\\libuv_new-1.48-res-new.json', 'w', encoding='utf-8') as f:
